...
import classes from './IconOutlinedOtherShopShoppingB.module.css';
...
/* @figmaId 18:36 */
export const IconOutlinedOtherShopShoppingB: FC<Props> = memo(function IconOutlinedOtherShopShoppingB(props = {}) {
  return (
